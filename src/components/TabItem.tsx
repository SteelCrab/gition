...
const TabItem = ({ name, active, unsaved, onClose }) => (
    <div
      ...
      ${active ? 'bg-white text-[#37352f] font-medium' : 'bg-[#f7f6f3] text-[#787774] hover:bg-[#efefef]'}
    `}
    >
        ...
        <button
            ...
            className={`ml-1 p-0.5 rounded hover:bg-black/5 ${active ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}
        >
            <X size={12} />
        </button>
    </div>
